...
- 'Gifts for Roll' now shows on multiple Support Car locations on the map.
- Blue Refractor now shows as static instead of togglable.

### Fixed

- Logic for Underground Ruins checks that can be accessed via Drill Arm.
